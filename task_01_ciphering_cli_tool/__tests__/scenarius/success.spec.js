...
describe('Success scenarios', () => {
    ...
    it('case one', () => {
        ...
        childProcess.stderr.on('end', () => { expect(result).toBe(successCases.caseOne.res); });
    });
    ...
    it('case two', () => {
        ...
        childProcess.stderr.on('data', (chunk) => { result = `${result}${chunk.toString()}`; });
        childProcess.stderr.on('end', () => { expect(result).toBe(successCases.caseTwo.res); });
    });
    ...
    it('case three', () => {
        ...
        childProcess.stderr.on('data', (chunk) => { result = `${result}${chunk.toString()}`; });
        childProcess.stderr.on('end', () => { expect(result).toBe(successCases.caseThree.res); });
    });
    ...
    it('case four', () => {
        ...
        childProcess.stderr.on('data', (chunk) => { result = `${result}${chunk.toString()}`; });
        childProcess.stderr.on('end', () => { expect(result).toBe(successCases.caseFour.res); });
    });
});
